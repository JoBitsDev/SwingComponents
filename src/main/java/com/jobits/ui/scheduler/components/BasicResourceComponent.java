...
/**
 * This is a very basic implementation of the AbstractResourceComponent. This
 * component does not draw any color or have any mouse notifications. If you
 * want to change the rendering or add mouse notification you need to create
 * your own ComponentFactory and extend AbstractResourceComponent. You can also
 * just extend this one if you only want to modify it slightly.
 *
...
public class BasicResourceComponent extends AbstractResourceComponent {
    ...
    /**
     * Constructor given a resource to wrap. This just saves off the resource
     * and sets a default background color of light gray. To change the
     * background color extend the ComponentFactory and make your own
     * components.
     *
     * @param resource (not null) Resource to wrap.
     */
    public BasicResourceComponent(Resource resource) {
        super(resource);
