...
public interface ScheduleModel {
     ...
     */
    void visitAppointments(AppointmentVisitor visitor, LocalDate dateTime);
     ...
     * @param dateTime (not null) The day to visit the appointments for.
     */
    void visitResources(ResourceVisitor visitor, LocalDate dateTime);
     ...
     */
    LocalTime getStartTime(LocalDate dateTime);

    /**
     * Get the end time for the day ... I'm thinking that this should really be
     * a dynamic value and not something set through the model.
     *
