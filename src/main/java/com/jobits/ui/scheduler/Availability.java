...
/**
 * An availability is a simple class that holds a single instance when a
 * resource is available. Availability is from given time for a given duration.
 * A resource may have multiple availabilities in a given day (like before lunch
 * and after lunch).
 *
...
public class Availability {
     ...
     */
    public Availability(LocalTime time, Duration duration) {
        _time = time;
        _duration = duration;
    }
