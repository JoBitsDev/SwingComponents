 ...
 * @author Home
 */
public class DarkMaterialTheme extends AbstractTheme implements ThemeService {

    public DarkMaterialTheme() {
...
//            return textField;
    ...
    public JPanel getPrimaryPanel() {
        JPanel secondaryPanel = new MaterialPanel(Color.DARK_GRAY);
        secondaryPanel.setToolTipText(null);
        return secondaryPanel;
    }

    public JPanel getSecondaryPanel() {
        JPanel secondaryPanel = new MaterialPanel(Color.GRAY);
        secondaryPanel.setToolTipText(null);
        return secondaryPanel;
    }
    ...
    public JPanel getHeaderPanel() {
        return new MaterialPanel(Color.DARK_GRAY);
    }
